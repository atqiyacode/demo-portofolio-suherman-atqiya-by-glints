...
@Component({
  selector: 'app-return-goods-delivery',
  templateUrl: './return-goods-delivery.component.html',
  styleUrls: ['./return-goods-delivery.component.css']
})
export class ReturnGoodsDeliveryComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  urlCreate = this.router.url + "/create-return-goods-delivery"
  ...
  ngOnInit() {
    ...
    fromEvent(this.searchInput.nativeElement, 'keyup').pipe(
      ...
      if (text == null || text == "") {
        ...
        let url = 'return-do/' + this.apiBackend.serviceAuth()['tenant_id'] + '/search/' + text
  ...
  table = false
  getAll() {
    this.apiBackend.Get('do-return').subscribe((data: {}) => {
      this.dataApi = data
  ...
  showById(id) {
    ...
    this.apiBackend.Show(url).subscribe((data: {}) => {
      ...
      this.noDelivery = this.dataShow.data.order.no_do
    },
      (err) => {
  ...
  formUpdate(id) {
    let urlUpdate = this.router.url + '/update-return-goods-delivery/' + id
    this.router.navigate([urlUpdate]);
  }
  formDetail(id) {
    let urlUpdate = this.router.url + '/detail-return-goods-delivery/' + id
    this.router.navigate([urlUpdate]);
  }
  onDelete() {
