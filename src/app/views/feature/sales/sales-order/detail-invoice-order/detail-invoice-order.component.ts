...
@Component({
  selector: 'app-detail-invoice-order',
  templateUrl: './detail-invoice-order.component.html',
  styleUrls: ['./detail-invoice-order.component.css']
})
export class DetailInvoiceOrderComponent implements OnInit {
