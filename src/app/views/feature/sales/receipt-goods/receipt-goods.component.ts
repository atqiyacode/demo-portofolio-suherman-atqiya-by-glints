...
@Component({
  selector: 'app-receipt-goods',
  templateUrl: './receipt-goods.component.html',
  styleUrls: ['./receipt-goods.component.css']
})
export class ReceiptGoodsComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  urlCreate = this.router.url + "/create-return-receipt"
  ...
  ngOnInit() {
    ...
    fromEvent(this.searchInput.nativeElement, 'keyup').pipe(
      ...
      if (text == null || text == "") {
        ...
        let url = 'return-good/' + this.apiBackend.serviceAuth()['tenant_id'] + '/search/' + text
  ...
  table = false
  getAll() {
    this.apiBackend.Get('return-good').subscribe((data: {}) => {
      this.dataApi = data
  ...
  formUpdate(id) {
    let urlUpdate = this.router.url + '/update-return-receipt/' + id
    this.router.navigate([urlUpdate]);
  }
  formDetail(id) {
    let urlUpdate = this.router.url + '/detail-return-receipt/' + id
    this.router.navigate([urlUpdate]);
  }
  onDelete() {
