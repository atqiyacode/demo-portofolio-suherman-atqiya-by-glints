...
@Component({
  selector: 'app-detail-receipt-goods',
  templateUrl: './detail-receipt-goods.component.html',
  styleUrls: ['./detail-receipt-goods.component.css']
})
export class DetailReceiptGoodsComponent implements OnInit {
