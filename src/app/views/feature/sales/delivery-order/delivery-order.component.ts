...
export class DeliveryOrderComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  urlCreate = this.router.url + "/create-delivery"
  ...
  ngOnInit() {
    ...
    fromEvent(this.searchInput.nativeElement, 'keyup').pipe(
      ...
      if (text == null || text == "") {
        ...
        let url = 'do/' + this.apiBackend.serviceAuth()['tenant_id'] + '/search/' + text
  ...
  formUpdate(id) {
    let urlUpdate = this.router.url + '/update-delivery/' + id
    this.router.navigate([urlUpdate]);
  }
  formDetail(id) {
    let urlUpdate = this.router.url + '/detail-delivery/' + id
    this.router.navigate([urlUpdate]);
  }
  onDelete() {
