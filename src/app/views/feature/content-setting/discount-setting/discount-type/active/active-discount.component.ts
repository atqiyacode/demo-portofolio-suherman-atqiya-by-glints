...
@Component({
    selector: 'app-active-discount',
    templateUrl: 'active-discount.component.html',
    styleUrls: ['../../../content-setting.css']
})

export class ActiveDiscountComponent implements OnInit {
  ...
  ngOnInit() {
    this.getDiscount();
    $('.active-discount').addClass('active');
    $('.all-discount').removeClass('active');
    $('.next-discount').removeClass('active');
    $('.passed-discount').removeClass('active');
    $('#nav-disc-all').show();
  }
